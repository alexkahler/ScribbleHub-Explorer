...
def main():
    ...
    st.markdown('___')
    st.markdown("""
*Update - 19-02-2023: I'm brainstorming ways to get the necessary data without accessing SH servers. Stay tuned for updates on [SH Forums](https://forum.scribblehub.com/threads/now-live-scribblehub-explorer-%E2%80%93-an-ai-powered-novel-recommendation-engine-feedback-needed.13028/page-2#post-275782)  
